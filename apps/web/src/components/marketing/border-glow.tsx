...
// Verified live-source port of React Bits BorderGlow
// (https://reactbits.dev/components/border-glow) — TS-TW variant, JS→typed TSX
// with no logic changes. See docs/ui-motion.md.
